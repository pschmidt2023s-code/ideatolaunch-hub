...
export const addonSuppliers: AddonSupplier[] = [
  ...
  { name: "SilkWrap (DE)", region: "EU", categories: [], estimatedMOQ: 500, estimatedUnitCostRange: [0.05, 0.15], leadTimeDays: 7, positioning: "mid", addonType: "tissue_paper", notes: "Seidenpapier mit Logo-Druck, recycelbar", website: "https://www.silkwrap.de" },
  ...
  // ── Sticker / Labels ──
  { name: "StickerGiant (DE)", region: "EU", categories: [], estimatedMOQ: 100, estimatedUnitCostRange: [0.08, 0.25], leadTimeDays: 5, positioning: "mid", addonType: "sticker", notes: "Vinyl & Papier-Sticker, diverse Formen", website: "https://www.stickergiant.de" },
  ...
  // ── Thank-You Cards ──
  { name: "Papeterie Studio (DE)", region: "EU", categories: [], estimatedMOQ: 200, estimatedUnitCostRange: [0.1, 0.4], leadTimeDays: 7, positioning: "premium", addonType: "thank_you_card", notes: "Premium-Papier, Letterpress, Custom Design", website: "https://www.papeterie-studio.de" },
  ...
  { name: "BoxUp (NL)", region: "EU", categories: [], estimatedMOQ: 100, estimatedUnitCostRange: [0.8, 3], leadTimeDays: 10, positioning: "premium", addonType: "custom_box", notes: "Mailer-Boxen, Magnetic Closure, Rigid Boxes", website: "https://www.boxup.nl" },
  ...
  // ── Sample Inserts ──
  { name: "PromoInsert (DE)", region: "EU", categories: [], estimatedMOQ: 300, estimatedUnitCostRange: [0.15, 0.5], leadTimeDays: 8, positioning: "mid", addonType: "sample_insert", notes: "Proben-Beilagen, Flyer, Discount-Codes", website: "https://www.promoinsert.de" },
  ...
  // ── Ribbons / Bänder ──
  { name: "BandWerk (DE)", region: "EU", categories: [], estimatedMOQ: 100, estimatedUnitCostRange: [0.1, 0.35], leadTimeDays: 7, positioning: "premium", addonType: "ribbon", notes: "Satinband mit Logo, Geschenkband", website: "https://www.bandwerk.de" },
];

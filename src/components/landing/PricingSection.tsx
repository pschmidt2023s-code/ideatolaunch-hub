...
export function PricingSection() {
  ...
  const proFeatures: PlanFeature[] = isDE ? [
    ...
    { label: "Price Benchmark Analyse", desc: "Abweichung vs. Marktdurchschnitt & Konkurrenzvergleich" },
    { label: "Competitor Positioning Score", desc: "Deine Position vs. Top-3-Wettbewerber mit Gap-Analyse" },
    { label: "Stress Test Simulation", desc: "Was passiert bei +20% Ads, +8% Retouren, -10% Preis?" },
    { label: "Worst-Case Modus", desc: "Maximale Belastung simulieren & Überlebenschancen prüfen" },
    { label: "Cashflow Survival Predictor", desc: "Runway, Working Capital Gap & Liquiditäts-Alerts" },
    { label: "Capital Burn Forecast", desc: "12-Monats-Kostenprognose mit Szenarien" },
    ...
    { label: "Price Benchmark Analysis", desc: "Deviation vs. market average & competitor comparison" },
    { label: "Competitor Positioning Score", desc: "Your position vs. top 3 competitors with gap analysis" },
    { label: "Stress Test Simulation", desc: "What if ads +20%, returns +8%, price -10%?" },
    { label: "Worst-Case Mode", desc: "Simulate maximum stress & check survival chances" },
    { label: "Cashflow Survival Predictor", desc: "Runway, working capital gap & liquidity alerts" },
    { label: "Capital Burn Forecast", desc: "12-month cost forecast with scenarios" },
          ...
          <div className="overflow-x-auto rounded-xl border">
            <table className="w-full text-sm">
              ...
              <tbody className="text-muted-foreground">
                {(isDE ? [
                  ["Market Reality Engine", "—", "Basis Demand", "Voll + Benchmark", "—"],
                  ["Competitor Intelligence", "—", "Übersicht", "Positioning Score", "—"],
                  ["Cashflow Survival Engine", "—", "Timeline", "Voll + Stress-Test", "—"],
                  ["Stress Test Simulation", "—", "—", "✓ + Worst Case", "—"],
                  ["Supplier Risk Index", "—", "Basis-Score", "5-Kategorie Heatmap", "—"],
                  ["Launch Probability Score", "—", "Readiness", "Wahrscheinlichkeit %", "—"],
                  ["AI Founder Copilot", "—", "3 Empfehlungen", "Voll + Chat", "—"],
                  ["Investor-Ready Report", "—", "PDF Export", "Investor-Ready", "Manuell"],
                  ...
                  ["Cashflow Survival Engine", "—", "Timeline", "Full + Stress Test", "—"],
                  ["Stress Test Simulation", "—", "—", "✓ + Worst Case", "—"],
                  ["Supplier Risk Index", "—", "Base Score", "5-Category Heatmap", "—"],
                  ["Launch Probability Score", "—", "Readiness", "Probability %", "—"],
                  ["AI Founder Copilot", "—", "3 Suggestions", "Full + Chat", "—"],
                  ["Investor-Ready Report", "—", "PDF Export", "Investor-Ready", "Manual"],
                  ["Save & Compare Scenarios", "—", "—", "✓ Compare", "—"],

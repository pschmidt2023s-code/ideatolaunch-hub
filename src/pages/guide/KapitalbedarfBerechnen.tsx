...
export default function KapitalbedarfBerechnen() {
  return (
    <GuideLayout title="Kapitalbedarf berechnen" seoTitle="Kapitalbedarf berechnen – Budgetplanung für Gründer" seoDescription="Berechne den Kapitalbedarf für deine Eigenmarke. Lerne, welche Kosten anfallen und wie du dein Budget optimal aufteilst." path="/guide/kapitalbedarf-berechnen" breadcrumbs={[{ name: "Home", href: "/" }, { name: "Guide", href: "/guide/eigenmarke-gruenden" }, { name: "Kapitalbedarf", href: "/guide/kapitalbedarf-berechnen" }]} jsonLd={faqJsonLd} recommendedLinks={[
      { href: "/tools/produktionskosten-rechner", label: "Produktionskosten berechnen", desc: "Kalkuliere deine Stückkosten mit dem kostenlosen Rechner." },
      { href: "/guide/break-even-rechner", label: "Break-Even verstehen", desc: "Lerne, ab wann dein Produkt profitabel wird." },
      { href: "/guide/launch-plan-erstellen", label: "Launch-Plan erstellen", desc: "Plane deinen Marktstart mit einer strukturierten Roadmap." },
    ]}>
